                ...
                if analyze and uploaded_file:
                    ...
                    if os.path.isfile(jsonfilename):
                        ...
                        with st.spinner('Analyzing '+uploaded_file.name+' with Azure AI Document Intelligence...'):
                            ...
                            file_name = os.path.join(st.session_state.project+'/files/', uploaded_file.name)
...
if st.session_state.vector_index_name != None:
    ...
    if(len(st.session_state.topic_list)>0):
        tab1, tab3 = st.tabs(["Document Viewer", "Q&A"])
        ...
        with tab3:
            col81, col82,col83, col84 = st.columns([1, 1, 1, 1])
            with col81:
